...
exports.isValidAirportCode = exports.getAirportsByRegion = exports.getUserDepartureAirports = exports.POPULAR_DESTINATIONS = exports.PROVINCIAL_AIRPORTS = exports.DEFAULT_AIRPORTS = void 0;
// Aéroports par défaut (reçus par TOUS les utilisateurs)
exports.DEFAULT_AIRPORTS = [
...
const getUserDepartureAirports = (user) => {
    const airports = [...exports.DEFAULT_AIRPORTS.map(a => a.code)];
...
exports.getUserDepartureAirports = getUserDepartureAirports;
// Fonction pour obtenir les aéroports par région
const getAirportsByRegion = () => {
    const grouped = exports.PROVINCIAL_AIRPORTS.reduce((acc, airport) => {
...
exports.getAirportsByRegion = getAirportsByRegion;
// Fonction pour valider un code aéroport
const isValidAirportCode = (code) => {
    const allAirports = [
        ...exports.DEFAULT_AIRPORTS.map(a => a.code),
        ...exports.PROVINCIAL_AIRPORTS.map(a => a.code),
        ...exports.POPULAR_DESTINATIONS.map(d => d.airportCode)
    ];
